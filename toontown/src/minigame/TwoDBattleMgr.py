...
##        self.WATER_SPRAY_COLOR = Point4(0.75, 0.75, 1.0, 0.8)
    ...
    def calcSprayEndPos(self):
        ...
        # If toon does't exist assume that the toon was facing right. Cheap HACK!!
        else:
...
##        sprayProp = globalPropPool.getProp('spray')
        ...
        track = Sequence(
            ...
            # Scaled the spray
            LerpScaleInterval(sprayScale, dSprayScale, calcTargetScale, startScale=MovieUtil.PNT3_NEARZERO),
            # Hold the spray
            Wait(dSprayHold),
