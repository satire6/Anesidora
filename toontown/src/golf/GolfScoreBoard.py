    ...
    def setup(self):
        ...
        for parHoleIndex in range(self.golfCourse.numHoles):
            parLabel= DirectLabel(
                parent = self.scoreboard,
                relief = None,
                pos = (self.lineVStart+0.055 + (horzOffset * parHoleIndex) , 0, holeTop - 0.1),
                #color = (0.4, 0.4, 0.4, 1),
                text_align = TextNode.ACenter,
        ...
        for playaIndex in range(self.numPlayas):
            ...
            for holeIndex in range(self.golfCourse.numHoles):
                holeLabel = DirectLabel(
                    parent = self.scoreboard,
                    relief = None,
                    pos = (self.lineVStart+ 0.055 + (horzOffset * holeIndex) , 0, (self.playaTop - (self.vertOffset * playaIndex) - self.vCenter)),
                    text_align = TextNode.ACenter,
                    text = "-",
                    text_scale = 0.05,
                    text_wordwrap = 10
            ...
            holeLabel = DirectLabel(
                parent = self.scoreboard,
                relief = None,
                pos = (self.lineVStart+ 0.1 + (horzOffset * 9.5) , 0, (self.playaTop - (self.vertOffset * playaIndex) - self.vCenter)),
                text_align = TextNode.ACenter,
                text = "-",
                text_scale = 0.05,
                text_wordwrap = 10
